              ...
              <div className="block py-16 max-md:py-12 md:max-lg:py-20 2xl:py-24" data-cid="n109">
                <div className="grid px-8 gap-x-3.5 grid-cols-24 grid-rows-1 max-md:px-4 max-md:gap-x-1.5 max-lg:grid-cols-2 max-lg:px-[2.05rem] md:max-lg:gap-x-[12.3px] 2xl:px-12 2xl:gap-x-[21.3px]" data-cid="n110">
                  <div className="block col-start-1 [grid-column-end:-3] max-lg:col-end-[-1]" data-cid="n111">
                    <div className="block invisible opacity-0 2xl:[visibility:inherit] 2xl:opacity-[initial]" data-cid="n112">
                      <div className="block text-[2.6875rem] leading-[3.125rem] tracking-[-1.71px] max-md:text-[1.75rem] max-md:leading-8 max-md:tracking-[-0.56px] md:max-lg:text-[3.5625rem] md:max-lg:leading-[4.125rem] md:max-lg:tracking-[-1.15px] 2xl:text-[4rem] 2xl:leading-[4.6875rem] 2xl:tracking-[-2.56px]" data-cid="n113">
                        ...
                        <div className="hidden 2xl:block 2xl:relative" aria-hidden="true">A conventional sequential sweep moves through bands in a fixed order</div>
<div className="hidden 2xl:block 2xl:relative" aria-hidden="true">Agile emitters can appear and disappear between visits</div>
<div className="hidden 2xl:block 2xl:relative" aria-hidden="true">AEGIS uses a dual-agent scheduler: EAGER chases active/occupied signals</div>
<div className="hidden 2xl:block 2xl:relative" aria-hidden="true">REVISIT monitors Age of Information and refreshes stale bands</div>
<div className="hidden 2xl:block 2xl:relative" aria-hidden="true">The result: Detect faster</div>
<div className="hidden 2xl:block 2xl:relative" aria-hidden="true">Reduce stale channels</div>
<div className="hidden 2xl:block 2xl:relative" aria-hidden="true">Explain every scheduling decision.</div></div></div></div>
                </div>
            ...
            <div className="relative w-full">
              ...
              <section className="block pt-[500vh] pb-[11.1125rem] max-md:pb-50 md:max-lg:pb-[25.6rem] 2xl:pb-[266.7px] relative w-full z-10" data-cid="n133">
            ...
            <div className="w-full min-h-[50vh] bg-background text-foreground py-16 px-6 md:px-16 flex items-center justify-center">
              ...
              >
                A conventional sequential sweep moves through bands in a fixed order. Agile emitters can appear and disappear between visits. AEGIS uses a dual-agent scheduler: EAGER chases active/occupied signals. REVISIT monitors Age of Information and refreshes stale bands. The result: Detect faster. Reduce stale channels. Explain every scheduling decision.
                {"\n"}A conventional sequential sweep moves through bands in a fixed order
                {"\n"}Agile emitters can appear and disappear between visits
                {"\n"}AEGIS uses a dual-agent scheduler: EAGER chases active/occupied signals
                {"\n"}REVISIT monitors Age of Information and refreshes stale bands
                {"\n"}The result: Detect faster
                {"\n"}Reduce stale channels
            ...
            <section className="block py-[106.7px] text-color-001 bg-foreground max-md:py-30 md:max-lg:py-[15.3625rem] 2xl:py-40" data-cid="n172">
              <div className="grid px-8 gap-x-3.5 grid-cols-24 max-md:px-4 max-md:gap-x-1.5 max-lg:grid-cols-2 md:max-lg:px-[2.05rem] md:max-lg:gap-x-[12.3px] 2xl:px-12 2xl:gap-x-[21.3px]" data-cid="n173">
                <div className="block col-start-1 col-end-[span_5] row-start-1 max-md:mb-10 max-lg:col-end-[-1] max-lg:[grid-row-start:initial] md:max-lg:mb-[5.125rem]" data-cid="n174">
                  <h3 className="block text-[2.6875rem] leading-[3.125rem] tracking-[-1.71px] max-md:text-[1.75rem] max-md:leading-8 max-md:tracking-[-0.56px] md:max-lg:text-[3.5625rem] md:max-lg:leading-[4.125rem] md:max-lg:tracking-[-1.15px] 2xl:text-[4rem] 2xl:leading-[4.6875rem] 2xl:tracking-[-2.56px]" data-cid="n175" data-component="heading">
                    C2 OPERATOR CELL
                  </h3>
                </div>
            ...
            <section className="block pt-[106.7px] pb-[133.3px] overflow-hidden bg-color-001 max-md:py-30 md:max-lg:py-[15.3625rem] 2xl:pt-40 2xl:pb-50" data-cid="n225">
              <div className="grid px-8 gap-x-3.5 grid-cols-24 max-md:px-4 max-md:gap-x-1.5 max-lg:grid-cols-2 md:max-lg:px-[2.05rem] md:max-lg:gap-x-[12.3px] 2xl:px-12 2xl:gap-x-[21.3px]" data-cid="n226">
                <div className="block col-start-[span_6] max-lg:col-span-full self-start lg:sticky lg:top-40 2xl:top-64" data-cid="n227">
                  ...
                  <div className="block" data-cid="n243">
                    <div className="block invisible opacity-0 mt-[0.725rem] text-[2rem] leading-[2.3125rem] tracking-[-1.28px] max-md:mt-[0.8125rem] max-md:text-[1.75rem] max-md:leading-7 max-md:tracking-[-1.12px] md:max-lg:mt-[1.6625rem] md:max-lg:text-[3.5625rem] md:max-lg:leading-[3.5625rem] md:max-lg:tracking-[-2.29px] 2xl:mt-[17.3px] 2xl:text-5xl 2xl:leading-14 2xl:tracking-[-1.92px] 2xl:[visibility:inherit] 2xl:opacity-[initial]" data-cid="n244">
                      <span className="block" data-cid="n245">
                        Initialize AEGIS and enter the live scan console.
                        <div className="hidden 2xl:block 2xl:relative" aria-hidden="true" aria-label="Initialize AEGIS and enter the live scan console.">
                          <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">I</div>
<div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">n</div>
<div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">i</div>
<div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">t</div>
<div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">i</div>
<div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">a</div>
<div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">l</div>
<div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">i</div>
<div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">z</div>
<div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">e</div>
{" "}
<div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">A</div>
<div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">E</div>
<div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">G</div>
<div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">I</div>
<div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">S</div>
{" "}
<div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">a</div>
<div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">n</div>
<div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">d</div>
{" "}
<div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">e</div>
<div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">n</div>
<div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">t</div>
<div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">e</div>
<div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">r</div>
{" "}
<div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">t</div>
<div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">h</div>
<div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">e</div>
{" "}
<div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">l</div>
<div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">i</div>
<div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">v</div>
<div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">e</div>
{" "}
<div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">s</div>
<div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">c</div>
<div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">a</div>
<div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">n</div>
{" "}
<div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">c</div>
<div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">o</div>
<div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">n</div>
<div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">s</div>
<div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">o</div>
<div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">l</div>
<div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">e</div>
<div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="dyn" aria-hidden="true">.</div>
                        </div>
                      </span>
                      <span className="block" data-cid="n263">
                        Elegant SCAN.
                        <div className="hidden 2xl:block 2xl:relative" data-cid="n264" aria-hidden="true" aria-label="Elegant SCAN.">
                          <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="n265" aria-hidden="true">
                            E
                          </div>
                          <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="n266" aria-hidden="true">
                            l
                          </div>
                          <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="n267" aria-hidden="true">
                            e
                          </div>
                          <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="n268" aria-hidden="true">
                            g
                          </div>
                          <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="n269" aria-hidden="true">
                            a
                          </div>
                          <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="n270" aria-hidden="true">
                            n
                          </div>
                          <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="n271" aria-hidden="true">
                            t
                          </div>
                          {" "}
                          <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="n272" aria-hidden="true">
                            S
                          </div>
                          <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="n273" aria-hidden="true">
                            o
                          </div>
                          <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="n274" aria-hidden="true">
                            l
                          </div>
                          <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="n275" aria-hidden="true">
                            u
                          </div>
                          <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="n276" aria-hidden="true">
                            t
                          </div>
                          <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="n277" aria-hidden="true">
                            i
                          </div>
                          <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="n278" aria-hidden="true">
                            o
                          </div>
                          <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="n279" aria-hidden="true">
                            n
                          </div>
                          <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="n280" aria-hidden="true">
                            s
                          </div>
                          <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="n281" aria-hidden="true">
                            .
                          </div>
                        </div>
                      </span>
                ...
                <div className="block mt-[26.7px] col-start-13 col-end-[-1] max-md:mt-15 max-lg:col-start-1 md:max-lg:mt-[122.9px] 2xl:mt-10" data-cid="n282">
                  <p className="block invisible opacity-0 text-clr-1 text-[1.3125rem] leading-[1.5625rem] tracking-[-0.85px] max-md:text-xl max-md:leading-6 max-md:tracking-[-0.8px] md:max-lg:text-[2.5625rem] md:max-lg:leading-[3.0625rem] md:max-lg:tracking-[-1.64px] 2xl:text-[2rem] 2xl:leading-[2.3125rem] 2xl:tracking-[-1.28px] 2xl:[visibility:inherit] 2xl:opacity-[initial]" data-cid="n283">
            ...
            <section className="h-200 min-h-screen block relative max-md:h-203 md:max-lg:h-256 2xl:h-270" data-cid="n321">
              <div className="grid px-8 gap-x-3.5 grid-cols-24 max-md:px-4 max-md:gap-x-1.5 max-lg:grid-cols-2 md:max-lg:px-[2.05rem] md:max-lg:gap-x-[12.3px] 2xl:px-12 2xl:gap-x-[21.3px]" data-cid="n322">
                <div className="block my-[106.7px] col-start-13 [grid-column-end:-3] max-md:my-30 max-lg:col-span-full md:max-lg:my-[15.3625rem] 2xl:my-40 self-start lg:sticky lg:top-40 2xl:top-64" data-cid="n323">
                  ...
                  <div className="block" data-cid="n341">
                    <div className="block invisible opacity-0 mt-8 text-[2rem] leading-[2.3125rem] tracking-[-1.28px] max-md:mt-9 max-md:text-[1.75rem] max-md:leading-7 max-md:tracking-[-1.12px] md:max-lg:mt-[73.7px] md:max-lg:text-[3.5625rem] md:max-lg:leading-[3.5625rem] md:max-lg:tracking-[-2.29px] 2xl:mt-12 2xl:text-5xl 2xl:leading-14 2xl:tracking-[-1.92px] 2xl:[visibility:inherit] 2xl:opacity-[initial]" data-cid="n342">
                      Performance Proven at Scale
                      <div className="hidden 2xl:block 2xl:relative" data-cid="n343" aria-hidden="true" aria-label="Performance Proven at Scale">
                        <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="n344" aria-hidden="true">
                          P
                        </div>
                        <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="n345" aria-hidden="true">
                          e
                        </div>
                        <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="n346" aria-hidden="true">
                          r
                        </div>
                        <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="n347" aria-hidden="true">
                          f
                        </div>
                        <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="n348" aria-hidden="true">
                          o
                        </div>
                        <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="n349" aria-hidden="true">
                          r
                        </div>
                        <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="n350" aria-hidden="true">
                          m
                        </div>
                        <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="n351" aria-hidden="true">
                          a
                        </div>
                        <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="n352" aria-hidden="true">
                          n
                        </div>
                        <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="n353" aria-hidden="true">
                          c
                        </div>
                        <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="n354" aria-hidden="true">
                          e
                        </div>
                        {" "}
                        <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="n355" aria-hidden="true">
                          P
                        </div>
                        <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="n356" aria-hidden="true">
                          r
                        </div>
                        <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="n357" aria-hidden="true">
                          o
                        </div>
                        <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="n358" aria-hidden="true">
                          v
                        </div>
                        <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="n359" aria-hidden="true">
                          e
                        </div>
                        <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="n360" aria-hidden="true">
                          n
                        </div>
                        {" "}
                        <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="n361" aria-hidden="true">
                          a
                        </div>
                        <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="n362" aria-hidden="true">
                          t
                        </div>
                        {" "}
                        <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="n363" aria-hidden="true">
                          S
                        </div>
                        <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="n364" aria-hidden="true">
                          c
                        </div>
                        <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="n365" aria-hidden="true">
                          a
                        </div>
                        <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="n366" aria-hidden="true">
                          l
                        </div>
                        <div className="hidden 2xl:inline-block 2xl:relative 2xl:[filter:blur(0px)]" data-cid="n367" aria-hidden="true">
                          e
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="block" data-cid="n368">
                    <p className="block invisible opacity-0 text-clr-3 text-[2rem] leading-[2.3125rem] tracking-[-1.28px] max-md:text-[1.75rem] max-md:leading-7 max-md:tracking-[-1.12px] md:max-lg:text-[3.5625rem] md:max-lg:leading-[3.5625rem] md:max-lg:tracking-[-2.29px] 2xl:text-5xl 2xl:leading-14 2xl:tracking-[-1.92px] 2xl:[visibility:inherit] 2xl:opacity-[initial]" data-cid="n369">
                  ...
                  <div className="block" data-cid="n370">
                    <a className="w-28 h-10 flex relative invisible opacity-0 mt-8 px-6 rounded-sm justify-center items-center overflow-hidden [font-family:'Google_Sans',_sans-serif] text-xs font-normal leading-5 tracking-[-0.48px] cursor-pointer max-md:mt-9 md:max-lg:mt-[73.7px] 2xl:mt-12 2xl:[visibility:inherit] 2xl:opacity-[initial]" data-cid="n371" href="/financing" label="Learn more">
            ...
            <section className="block relative z-1 pb-8 max-md:-mt-27.5 max-md:pb-50 md:max-lg:mt-[-225.3px] md:max-lg:pb-[25.6rem] 2xl:pb-12" data-cid="n378">
              <div className="grid px-8 gap-x-3.5 grid-cols-24 grid-rows-1 max-md:px-4 max-md:gap-x-1.5 max-lg:grid-cols-2 max-lg:px-[2.05rem] md:max-lg:gap-x-[12.3px] 2xl:px-12 2xl:gap-x-[21.3px]" data-cid="n379">
                <div className="grid invisible opacity-0 gap-3.5 col-span-full grid-cols-24 grid-rows-2 max-md:gap-y-4 max-md:gap-x-1.5 max-lg:grid-cols-2 max-lg:grid-rows-4 md:max-lg:gap-y-[2.05rem] md:max-lg:gap-x-[12.3px] 2xl:gap-[21.3px] 2xl:[visibility:inherit] 2xl:opacity-[initial]" data-cid="n380">
                  <div className="flex relative p-[42.7px] rounded-[49.8px] flex-col col-start-[span_12] overflow-hidden bg-color-001 max-md:p-4 max-md:rounded-3xl max-lg:col-span-full max-lg:aspect-square md:max-lg:p-[2.05rem] md:max-lg:rounded-[49.2px] 2xl:p-16 2xl:rounded-[74.7px]" data-cid="n381">
                    <div className="flex self-end" data-cid="n382">
                      <div className="block opacity-0 text-muted-foreground text-[6.6875rem] [font-weight:250] leading-[6.6875rem] tracking-[-8.53px] max-md:text-8xl max-md:leading-24 max-md:tracking-[-7.68px] md:max-lg:text-[12.3125rem] md:max-lg:leading-[12.3125rem] md:max-lg:tracking-[-15.73px] 2xl:text-[10rem] 2xl:leading-40 2xl:tracking-[-12.8px] 2xl:opacity-[initial]" data-cid="n383">
                        16
                      </div>
                    </div>
                    <div className="block mt-[7.1875rem] max-md:mt-[129.3px] md:max-lg:mt-[18.0375rem] 2xl:mt-[11.6375rem]" data-cid="n385">
                      <div className="block" data-cid="n386">
                        <h3 className="block opacity-0 text-lg leading-[1.3125rem] tracking-[-0.36px] max-md:leading-[1.375rem] md:max-lg:text-[2.3125rem] md:max-lg:leading-[2.8125rem] md:max-lg:tracking-[-0.74px] 2xl:text-[1.6875rem] 2xl:leading-8 2xl:tracking-[-0.53px] 2xl:opacity-[initial]" data-cid="n387">
                      ...
                      <div className="block" data-cid="n389">
                        <div className="block opacity-0 max-w-[266.7px] mt-3.5 text-muted-foreground text-sm leading-[1.25rem] tracking-[-0.28px] max-md:max-w-63.5 max-md:mt-1.5 max-md:leading-[1.1875rem] md:max-lg:max-w-[32.5125rem] md:max-lg:mt-[12.3px] md:max-lg:text-lg md:max-lg:leading-[1.5625rem] md:max-lg:tracking-[-0.36px] 2xl:max-w-100 2xl:mt-[21.3px] 2xl:text-lg 2xl:leading-[1.5625rem] 2xl:tracking-[-0.36px] 2xl:opacity-[initial]" data-cid="n390">
                  ...
                  <div className="flex relative p-[42.7px] rounded-[49.8px] flex-col col-start-[span_12] overflow-hidden bg-color-001 max-md:p-4 max-md:rounded-3xl max-lg:col-span-full max-lg:aspect-square md:max-lg:p-[2.05rem] md:max-lg:rounded-[49.2px] 2xl:p-16 2xl:rounded-[74.7px]" data-cid="n392">
                    <div className="flex self-end" data-cid="n393">
                      <div className="block opacity-0 text-muted-foreground text-[6.6875rem] [font-weight:250] leading-[6.6875rem] tracking-[-8.53px] max-md:text-8xl max-md:leading-24 max-md:tracking-[-7.68px] md:max-lg:text-[12.3125rem] md:max-lg:leading-[12.3125rem] md:max-lg:tracking-[-15.73px] 2xl:text-[10rem] 2xl:leading-40 2xl:tracking-[-12.8px] 2xl:opacity-[initial]" data-cid="n394">
                        850
                    ...
                    <div className="block mt-[7.1875rem] max-md:mt-[129.3px] md:max-lg:mt-[20.85rem] 2xl:mt-[13.1875rem]" data-cid="n396">
                      <div className="block" data-cid="n397">
                        <h3 className="block opacity-0 text-lg leading-[1.3125rem] tracking-[-0.36px] max-md:leading-[1.375rem] md:max-lg:text-[2.3125rem] md:max-lg:leading-[2.8125rem] md:max-lg:tracking-[-0.74px] 2xl:text-[1.6875rem] 2xl:leading-8 2xl:tracking-[-0.53px] 2xl:opacity-[initial]" data-cid="n398">
                      ...
                      <div className="block" data-cid="n400">
                        <div className="block opacity-0 max-w-[266.7px] mt-3.5 text-muted-foreground text-sm leading-[1.25rem] tracking-[-0.28px] max-md:max-w-63.5 max-md:mt-1.5 max-md:leading-[1.1875rem] md:max-lg:max-w-[32.5125rem] md:max-lg:mt-[12.3px] md:max-lg:text-lg md:max-lg:leading-[1.5625rem] md:max-lg:tracking-[-0.36px] 2xl:max-w-100 2xl:mt-[21.3px] 2xl:text-lg 2xl:leading-[1.5625rem] 2xl:tracking-[-0.36px] 2xl:opacity-[initial]" data-cid="n401">
                  ...
                  <div className="flex relative p-[42.7px] rounded-[49.8px] flex-col col-start-[span_12] overflow-hidden bg-color-001 max-md:p-4 max-md:rounded-3xl max-lg:col-span-full max-lg:aspect-square md:max-lg:p-[2.05rem] md:max-lg:rounded-[49.2px] 2xl:p-16 2xl:rounded-[74.7px]" data-cid="n403">
                    <div className="flex self-end" data-cid="n404">
                      <div className="block opacity-0 text-muted-foreground text-[6.6875rem] [font-weight:250] leading-[6.6875rem] tracking-[-8.53px] max-md:text-8xl max-md:leading-24 max-md:tracking-[-7.68px] md:max-lg:text-[12.3125rem] md:max-lg:leading-[12.3125rem] md:max-lg:tracking-[-15.73px] 2xl:text-[10rem] 2xl:leading-40 2xl:tracking-[-12.8px] 2xl:opacity-[initial]" data-cid="n405">
                        2
                      </div>
                      <Icon4 cid={"n406"} />
                    </div>
                    <div className="block mt-[8.4125rem] max-md:mt-[148.5px] md:max-lg:mt-[20.85rem] 2xl:mt-[13.1875rem]" data-cid="n407">
                      <div className="block" data-cid="n408">
                        <h3 className="block opacity-0 text-lg leading-[1.3125rem] tracking-[-0.36px] max-md:leading-[1.375rem] md:max-lg:text-[2.3125rem] md:max-lg:leading-[2.8125rem] md:max-lg:tracking-[-0.74px] 2xl:text-[1.6875rem] 2xl:leading-8 2xl:tracking-[-0.53px] 2xl:opacity-[initial]" data-cid="n409">
                      ...
                      <div className="block" data-cid="n411">
                        <div className="block opacity-0 max-w-[266.7px] mt-3.5 text-muted-foreground text-sm leading-[1.25rem] tracking-[-0.28px] max-md:max-w-63.5 max-md:mt-1.5 max-md:leading-[1.1875rem] md:max-lg:max-w-[32.5125rem] md:max-lg:mt-[12.3px] md:max-lg:text-lg md:max-lg:leading-[1.5625rem] md:max-lg:tracking-[-0.36px] 2xl:max-w-100 2xl:mt-[21.3px] 2xl:text-lg 2xl:leading-[1.5625rem] 2xl:tracking-[-0.36px] 2xl:opacity-[initial]" data-cid="n412">
                  ...
                  <div className="flex relative p-[42.7px] rounded-[49.8px] flex-col col-start-[span_12] overflow-hidden bg-color-001 max-md:p-4 max-md:rounded-3xl max-lg:col-span-full max-lg:aspect-square md:max-lg:p-[2.05rem] md:max-lg:rounded-[49.2px] 2xl:p-16 2xl:rounded-[74.7px]" data-cid="n414">
                    <div className="flex self-end" data-cid="n414-top">
                      <div className="block opacity-0 text-muted-foreground text-[6.6875rem] [font-weight:250] leading-[6.6875rem] tracking-[-8.53px] max-md:text-8xl max-md:leading-24 max-md:tracking-[-7.68px] md:max-lg:text-[12.3125rem] md:max-lg:leading-[12.3125rem] md:max-lg:tracking-[-15.73px] 2xl:text-[10rem] 2xl:leading-40 2xl:tracking-[-12.8px] 2xl:opacity-[initial]">
                        1
                      </div>
                    </div>
                    <div className="block mt-[15.075rem] max-md:mt-[244.5px] md:max-lg:mt-[34.6875rem] 2xl:mt-[23.1875rem]" data-cid="n415">
                      <div className="block" data-cid="n416">
                        <h3 className="block opacity-0 text-lg leading-[1.3125rem] tracking-[-0.36px] max-md:leading-[1.375rem] md:max-lg:text-[2.3125rem] md:max-lg:leading-[2.8125rem] md:max-lg:tracking-[-0.74px] 2xl:text-[1.6875rem] 2xl:leading-8 2xl:tracking-[-0.53px] 2xl:opacity-[initial]" data-cid="n417">
                      ...
                      <div className="block" data-cid="n419">
                        <div className="block opacity-0 max-w-[266.7px] mt-3.5 text-muted-foreground text-sm leading-[1.25rem] tracking-[-0.28px] max-md:max-w-63.5 max-md:mt-1.5 max-md:leading-[1.1875rem] md:max-lg:max-w-[32.5125rem] md:max-lg:mt-[12.3px] md:max-lg:text-lg md:max-lg:leading-[1.5625rem] md:max-lg:tracking-[-0.36px] 2xl:max-w-100 2xl:mt-[21.3px] 2xl:text-lg 2xl:leading-[1.5625rem] 2xl:tracking-[-0.36px] 2xl:opacity-[initial]" data-cid="n420">
