export default function Icon4({ cid }: { cid?: string }) {
 return (
 <svg className="w-[2.5625rem] h-[2.5625rem] block ml-2.5 self-start overflow-hidden text-muted-foreground max-md:w-[1.6875rem] max-md:h-[1.6875rem] max-md:ml-[0.6875rem] md:max-lg:w-[3.4375rem] md:max-lg:h-[3.4375rem] md:max-lg:ml-[22.5px] 2xl:w-[3.8125rem] 2xl:h-[3.8125rem] 2xl:ml-[14.7px] " fill="none" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" data-v-2d08c9a7="" data-cid={cid}>
