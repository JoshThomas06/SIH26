export default function Icon2({ cid }: { cid?: string }) {
 return (
 <svg className="w-auto h-[3.4375rem] block overflow-hidden max-md:h-4 md:max-lg:h-[2.0625rem]" fill="none" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" data-v-6793bbed="" data-cid={cid}>
