...
export default function MediaLink({ d, cids }: { d: MediaLinkData; cids: string[] }) {
 ...
 {"Read more "}
 <div data-cid={cids[5]} className="w-[10.7px] h-[10.7px] flex justify-center items-center overflow-hidden max-md:w-3.5 max-md:h-3.5 md:max-lg:w-[28.7px] md:max-lg:h-[28.7px] 2xl:w-4 2xl:h-4 ">
