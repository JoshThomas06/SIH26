...
export default function HeroVideo() {
 ...
 return (
 <div className="relative w-full z-0" data-cid="hero-video-container">
 ...
 Red = illustrative threat corridors
  ...
  <Link to="/login" className="inline-block bg-[#00ff00] text-black px-8 py-3 rounded-full hover:bg-white transition-colors uppercase font-bold tracking-widest text-xs md:text-sm shadow-[0_0_20px_rgba(0,255,0,0.3)] hover:shadow-[0_0_25px_rgba(255,255,255,0.5)]">
